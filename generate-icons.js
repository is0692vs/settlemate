...
console.log(
  "   1. Use the generated SVG files directly (most modern browsers support this)"
);
console.log(
  "   2. Convert to PNG using an online tool like https://cloudconvert.com/svg-to-png"
);
console.log(
  "   3. Or use a tool like sharp: pnpm add -D sharp && node convert-svg-to-png.js"
);
